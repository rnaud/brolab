  ...
  $(".bg").each(function(index) {
    ...
    bgImg.src = bgImgSrc;
      ...
      $('.viewport').mouseenter(function(e) {
        $(this).children('a').children('img').animate({ height: '200', left: '0', top: '0', width: '330'}, 100);
        $(this).children('a').children('span').fadeIn(200);
    }).mouseleave(function(e) {
        $(this).children('a').children('img').animate({ height: '200', left: '-20', top: '-20', width: '330'}, 100);
